...
var s = new irc.Service(new irc.UnrealProtocol({ password: 'ykbots', sid: '9JS', serviceHost: 'services.YkBots.tk' }));
//se arregla la linea de arriba.
//var s = new irc.Service(new irc.UnrealProtocol({ numeric: 1, serviceHost: 'ykbots.tk' }));
...
with (s)
{
	connect("ykbots.tk", 7000, function ()
	{
		...
		var b = createBot("Services", "nodejs", "node.js bot", "bot.node.js");
		b.join("#YkBots");
		
		b.on('test', function ()
		{
			b.say("#YkBots", "Servicios conectados!");
		});
